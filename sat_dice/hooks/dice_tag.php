...
$forum_page['diceform_row']['sum_mod'] = '<p id="sat_dice_mod_row">'.$lang_sat_dice['mod'].' <input name="sum_mod" type="number" value="0"></p>';
$forum_page['diceform_row']['diff'] = '<p id="sat_dice_diff_row">'.$lang_sat_dice['diff'].' <input name="diff" type="number" value="0"></p>';
$forum_page['diceform_row']['desc'] = '<p id="sat_dice_desc_row">'.$lang_sat_dice['desc'].' <input name="desc" type="text" value="" placeholder="краткое описание ситуации, не обязательно"></p>';
$forum_page['diceform_row']['show'] = '<p id="sat_dice_show_row">'.$lang_sat_dice['show'].' <input name="min" type="checkbox"> '.$lang_sat_dice['min'].' <input name="max" type="checkbox"> '.$lang_sat_dice['max'].'<input name="sum" type="checkbox" checked="">'.$lang_sat_dice['sum'].'</p>';
...
$forum_page['diceform_button']['extra'] = '<span id="sat_dice_extra_but" class="button"><input type="button" value="'.$lang_sat_dice['extra'].'" onclick="showDiceExtra()"></span>';
